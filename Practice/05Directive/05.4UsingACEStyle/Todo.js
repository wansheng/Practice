...
ngTodo.directive("deleteButton", function () {
    return {
        ...
        template: '<button type="button" ng-click="action()"><i class="fa fa-trash-o"></i> {{text}}</button>'
    };
});
...
ngTodo.directive("addButton", function () {
    return {
        ...
        template: '<button type="button" ng-click="action()" class="danger"><i class="fa fa-plus-square"></i> {{text}}</button>'
    };
});
...
ngTodo.directive("removeCompletedButton", function () {
    return {
        ...
        template: '<button type="button" ng-click="action()"><i class="fa fa-archive"></i> {{text}}</button>'
    };
});
